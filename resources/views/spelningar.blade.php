<x-layout>
    ...
    <div class="text-white mx-auto w-full max-w-4xl p-8 pt-6">
        ...
        <div
            ...
            <p class="flex-row justify-center items-center bg-sky-900 bg-opacity-80 rounded-b-lg p-2 py-4 text-xl">
                <img src="{{ asset('/images/swish.png') }}" class="inline-block w-24 -mt-1 mr-4"><span
                    class="font-bold">100
                    SEK</span> /
                Person
            </p>
